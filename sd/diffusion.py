...
class UNET_AttentionBlock(nn.Module):
    ...
    def __init__(self, n_head, n_embd, d_context=768):
        ...
        self.attention_2 = CrossAttention(
            n_head, channels, d_context, inproj_bias=False
        )
    ...
    def __init__(self):
        ...
        self.encoders = nn.Module(
            [
                ...
                SwitchSequential(
                    UNET_ReidualBlock(320, 320), UNET_AttentionBlock(8, 40)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(320, 320), UNET_AttentionBlock(8, 40)
                ),
                ...
                SwitchSequential(
                    UNET_ReidualBlock(320, 640), UNET_AttentionBlock(8, 80)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(640, 640), UNET_AttentionBlock(8, 80)
                ),
                ...
                SwitchSequential(
                    UNET_ReidualBlock(640, 1280), UNET_AttentionBlock(8, 160)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(1280, 1280), UNET_AttentionBlock(8, 160)
                ),
        ...
        self.decoders = nn.ModuleList(
            [
                ...
                SwitchSequential(
                    UNET_ReidualBlock(2560, 1280), UNET_AttentionBlock(8, 160)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(2560, 1280),
                    UNET_AttentionBlock(8, 160),
                    UpSample(1280),
                ),
                SwitchSequential(
                    UNET_ReidualBlock(1920, 640), UNET_AttentionBlock(8, 80)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(1280, 640),
                    UNET_AttentionBlock(8, 80),
                    UpSample(640),
                ),
                SwitchSequential(
                    UNET_ReidualBlock(960, 640), UNET_AttentionBlock(8, 40)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(640, 320), UNET_AttentionBlock(8, 80)
                ),
                SwitchSequential(
                    UNET_ReidualBlock(640, 320), UNET_AttentionBlock(8, 40)
                ),
            ]
        )
