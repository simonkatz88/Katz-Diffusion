...
class VAE_Encoder(nn.Sequential):
    def __init__(self):
        super().__init__(
            ...
            # (Batch_Size, 256, height /4 , Width / 4) - (Batch_Size, 128, Height / 4, Width / 4)
            ...
            nn.Conv2d(512, 512, kernel_size=3, stride=2, padding=2),
    ...
    def forward(self, x: torch.Tensor, noise: torch.Tensor) -> torch.Tensor:
        ...
        # See https://github.com/huggingface/diffusers/issues/437 for explanation
        x *= 0.18215
